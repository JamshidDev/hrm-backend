...
namespace Illuminate\Support\Facades {
     ...
     */        class Bus {
         ...
         */        public static function except($jobsToDispatch)
        {
                    ...
                    /**
         * Assert if a job was dispatched based on a truth-tests callback.
         *
         ...
         */        public static function assertDispatchedTimes($command, $times = 1)
        {
                    ...
                    /**
         * Determine if a job was dispatched based on a truth-tests callback.
         *
         * @param string|\Closure $command
         ...
         */        public static function assertNothingDispatched()
        {
                    ...
                    /**
         * Assert if a job was explicitly dispatched synchronously based on a truth-tests callback.
         *
         * @param string|\Closure $command
         * @param callable|int|null $callback
         * @return void
         ...
         */        public static function assertNotDispatchedSync($command, $callback = null)
        {
                    ...
                    /**
         * Assert if a job was dispatched after the response was sent based on a truth-tests callback.
         *
         * @param string|\Closure $command
         * @param callable|int|null $callback
         * @return void
         ...
         */        public static function assertChained($expectedChain)
        {
                    ...
                    /**
         * Assert if a job was dispatched with an empty chain based on a truth-tests callback.
         *
         * @param string|\Closure $command
         * @param callable|null $callback
         * @return void
         ...
         */        public static function chainedBatch($callback)
        {
                    ...
                    /**
         * Assert if a batch was dispatched based on a truth-tests callback.
         *
         * @param callable $callback
         * @return void
         * @static
         ...
         */        public static function assertNothingBatched()
        {
                    ...
                    /**
         * Get all of the jobs matching a truth-tests callback.
         *
         * @param string $command
         * @param callable|null $callback
         ...
         */        public static function dispatched($command, $callback = null)
        {
                    ...
                    /**
         * Get all of the jobs dispatched synchronously matching a truth-tests callback.
         *
         * @param string $command
         * @param callable|null $callback
         * @return \Illuminate\Support\Collection
         ...
         */        public static function dispatchedSync($command, $callback = null)
        {
                    ...
                    /**
         * Get all of the jobs dispatched after the response was sent matching a truth-tests callback.
         *
         * @param string $command
         * @param callable|null $callback
         * @return \Illuminate\Support\Collection
         ...
         */        public static function dispatchedAfterResponse($command, $callback = null)
        {
                    ...
                    /**
         * Get all of the pending batches matching a truth-tests callback.
         *
         * @param callable $callback
         * @return \Illuminate\Support\Collection
         * @static
     ...
     */        class Event {
         ...
         */        public static function assertListening($expectedEvent, $expectedListener)
        {
                    ...
                    /**
         * Assert if an event was dispatched based on a truth-tests callback.
         *
         ...
         */        public static function assertDispatchedTimes($event, $times = 1)
        {
                    ...
                    /**
         * Determine if an event was dispatched based on a truth-tests callback.
         *
         * @param string|\Closure $event
         * @param callable|null $callback
         * @return void
         ...
         */        public static function assertNothingDispatched()
        {
                    ...
                    /**
         * Get all of the events matching a truth-tests callback.
         *
         * @param string $event
         * @param callable|null $callback
         * @return \Illuminate\Support\Collection
     ...
     */        class Http {
         ...
         */        public static function recordRequestResponsePair($request, $response)
        {
                    ...
                    /**
         * Assert that a request / response pair was recorded matching a given truth tests.
         *
         * @param callable $callback
         * @return void
         * @static
         ...
         */        public static function assertSentInOrder($callbacks)
        {
                    ...
                    /**
         * Assert that a request / response pair was not recorded matching a given truth tests.
         *
         * @param callable $callback
         * @return void
         * @static
         ...
         */        public static function assertSequencesAreEmpty()
        {
                    ...
                    /**
         * Get a collection of the request / response pairs matching the given truth tests.
         *
         * @param callable $callback
         * @return \Illuminate\Support\Collection
         * @static
     ...
     */        class Mail {
         ...
         */        public static function forgetMailers()
        {
                    ...
                    /**
         * Assert if a mailable was sent based on a truth-tests callback.
         *
         ...
         */        public static function assertSent($mailable, $callback = null)
        {
                    ...
                    /**
         * Determine if a mailable was not sent or queued to be sent based on a truth-tests callback.
         *
         * @param string|\Closure $mailable
         * @param callable|null $callback
         * @return void
         ...
         */        public static function assertNotOutgoing($mailable, $callback = null)
        {
                    ...
                    /**
         * Determine if a mailable was not sent based on a truth-tests callback.
         *
         * @param string|\Closure $mailable
         ...
         */        public static function assertNothingSent()
        {
                    ...
                    /**
         * Assert if a mailable was queued based on a truth-tests callback.
         *
         * @param string|\Closure $mailable
         * @param callable|array|string|int|null $callback
         * @return void
         ...
         */        public static function assertQueued($mailable, $callback = null)
        {
                    ...
                    /**
         * Determine if a mailable was not queued based on a truth-tests callback.
         *
         * @param string|\Closure $mailable
         * @param callable|array|string|null $callback
         * @return void
         ...
         */        public static function assertOutgoingCount($count)
        {
                    ...
                    /**
         * Get all of the mailables matching a truth-tests callback.
         *
         * @param string|\Closure $mailable
         * @param callable|null $callback
         * @return \Illuminate\Support\Collection
         ...
         */        public static function hasSent($mailable)
        {
                    ...
                    /**
         * Get all of the queued mailables matching a truth-tests callback.
         *
         * @param string|\Closure $mailable
         * @param callable|null $callback
         * @return \Illuminate\Support\Collection
     ...
     */        class Notification {
        ...
        {            //Method inherited from \Illuminate\Support\Manager
                    ...
                    /**
         * Assert if a notification was sent on-demand based on a truth-tests callback.
         *
         ...
         */        public static function assertSentOnDemand($notification, $callback = null)
        {
                    ...
                    /**
         * Assert if a notification was sent based on a truth-tests callback.
         *
         ...
         */        public static function assertSentToTimes($notifiable, $notification, $times = 1)
        {
                    ...
                    /**
         * Determine if a notification was sent based on a truth-tests callback.
         *
         * @param mixed $notifiable
         * @param string|\Closure $notification
         * @param callable|null $callback
         ...
         */        public static function assertCount($expectedCount)
        {
                    ...
                    /**
         * Get all of the notifications matching a truth-tests callback.
         *
         * @param mixed $notifiable
         * @param string $notification
         * @param callable|null $callback
     ...
     */        class Process {
         ...
         */        public static function preventingStrayProcesses()
        {
                    ...
                    /**
         * Assert that a process was recorded matching a given truth tests.
         *
         * @param \Closure|string $callback
         * @return \Illuminate\Process\Factory
         * @static
         */        public static function assertRan($callback)
        {
                    ...
                    /**
         * Assert that a process was recorded a given number of times matching a given truth tests.
         *
         * @param \Closure|string $callback
         * @param int $times
         * @return \Illuminate\Process\Factory
         ...
         */        public static function assertRanTimes($callback, $times = 1)
        {
                    ...
                    /**
         * Assert that a process was not recorded matching a given truth tests.
         *
         * @param \Closure|string $callback
         * @return \Illuminate\Process\Factory
         * @static
     ...
     */        class Queue {
         ...
         */        public static function except($jobsToBeQueued)
        {
                    ...
                    /**
         * Assert if a job was pushed based on a truth-tests callback.
         *
         ...
         */        public static function assertPushedOn($queue, $job, $callback = null)
        {
                    ...
                    /**
         * Assert if a job was pushed with chained jobs based on a truth-tests callback.
         *
         * @param string $job
         * @param array $expectedChain
         * @param callable|null $callback
         ...
         */        public static function assertPushedWithChain($job, $expectedChain = [], $callback = null)
        {
                    ...
                    /**
         * Assert if a job was pushed with an empty chain based on a truth-tests callback.
         *
         * @param string $job
         * @param callable|null $callback
         * @return void
         ...
         */        public static function assertPushedWithoutChain($job, $callback = null)
        {
                    ...
                    /**
         * Assert if a closure was pushed based on a truth-tests callback.
         *
         * @param callable|int|null $callback
         * @return void
         * @static
         */        public static function assertClosurePushed($callback = null)
        {
                    ...
                    /**
         * Assert that a closure was not pushed based on a truth-tests callback.
         *
         * @param callable|null $callback
         * @return void
         * @static
         */        public static function assertClosureNotPushed($callback = null)
        {
                    ...
                    /**
         * Determine if a job was pushed based on a truth-tests callback.
         *
         * @param string|\Closure $job
         * @param callable|null $callback
         * @return void
