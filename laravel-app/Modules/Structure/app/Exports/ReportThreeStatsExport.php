...
class ReportThreeStatsExport implements FromCollection, WithHeadings, WithEvents, WithStyles
{
    ...
    public function __construct($rows, $maxDepth, $year, $month)
    {
        ...
        $this->statColumns = [
            'month_created', 'month_other_created',
            'month_other_created_men', 'month_other_created_women',
            'month_updated', 'month_updated_men', 'month_updated_women',
            'month_created_30', 'month_created_univer', 'month_created_tex',
            'month_created_other_univer', 'month_created_coll', 'month_created_school',
            'month_created_band', 'month_deleted', 'vacancies'
        ];
    }
    ...
    public function headings(): array
    {
        return [
            ...
            [
                ...
                . '" yil "' . (Helper::getMonth($this->month ?? now()->month)) . '" oyida ishga qabul qilingan hamda mehnat
    ...
    public function getStyleEvent($sheet): void
    {
        ...
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 2))->setWidth(14);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 3))->setWidth(16);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 4))->setWidth(10);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 5))->setWidth(10);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 6))->setWidth(16);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 7))->setWidth(10);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 8))->setWidth(10);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 9))->setWidth(14);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 10))->setWidth(14);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 11))->setWidth(16);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 12))->setWidth(18);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 13))->setWidth(16);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 14))->setWidth(16);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 15))->setWidth(16);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 16))->setWidth(16);
        $sheet->getColumnDimension(Coordinate::stringFromColumnIndex($maxDepth + 17))->setWidth(16);
        ...
        $colors = [
            ...
            [$maxDepth + 6, $maxDepth + 9, 'D9EAD3'],
            [$maxDepth + 10, $maxDepth + 13, 'FFF2CC'],
            [$maxDepth + 14, $maxDepth + 17, 'F4CCCC']
        ];
