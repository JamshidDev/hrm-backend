...
class LateCommersExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithEvents, WithColumnWidths
{
    ...
    public function columnWidths(): array
    {
        ...
        $short = ['#'];
        $medium = ['worker', 'event_time', 'event_type'];
        $long = ['worker_position', 'organization', 'terminal'];
