...
export class QueryHcpWorkerDto {
  ...
  added?: string;
  @ApiPropertyOptional({
    description: 'organizations CSV: 151,154',
    example: '151',
  })
  @IsOptional()
  @IsString()
...
// Laravel: HikCentralWorkerUpdateFaceRequest — barcha maydonlar nullable.
export class UpdateFaceDto {
  @ApiPropertyOptional({ description: 'WorkerHikCentral.id (existing)' })
  @IsOptional()
  @IsInt()
  id?: number;
  @ApiPropertyOptional()
  ...
  @IsInt()
  worker_id?: number;
  @ApiPropertyOptional({ description: 'WorkerPhoto.id' })
  @IsOptional()
  @IsInt()
  photo_id?: number;
  @ApiPropertyOptional({ description: 'base64 data URL or raw' })
  ...
  @IsString()
  photo?: string | null;
  @ApiPropertyOptional({ description: 'expiry (Y-m-d)' })
  @IsOptional()
  @IsString()
  to?: string | null;
