...
export class WorkerPositionController {
  ...
  @Get()
  @UseGuards(PermissionGuard) @Permission('hr-workers-read')
  ...
  @Get(':uuid/edit')
  @UseGuards(PermissionGuard) @Permission('hr-workers-write')
  ...
  @Put(':id/update')
  @UseGuards(PermissionGuard) @Permission('hr-workers-write')
  @ApiOperation({ summary: 'Update worker_position fields (contract/group/rank/etc.)' })
...
export class WorkerPositionExtrasController {
  ...
  @ApiOperation({ summary: 'Worker position info (with department/position/contract/schedule)' })
