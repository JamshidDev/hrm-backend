...
export const COMMAND_ADDITIONAL: { uz: object; ru: object; en: object } = {
  uz: {
    delete_additional: {
      pension_count:
        "Birinchi marta pensiyaga chiqish (Oylik maoshidan ko'paytma)",
      pension_coefficient:
        'Birinchi marta pensiyaga chiqish (Oylik maoshidan foiz)',
  ...
  ru: {
    delete_additional: {
      pension_count:
        'Первичный выход на пенсию (надбавка от месячной зарплаты)',
      pension_coefficient:
        'Первичный выход на пенсию (процент от месячной зарплаты)',
  ...
  en: {
    delete_additional: {
      ...
      pension_coefficient:
        'First-time retirement (percentage from monthly salary)',
