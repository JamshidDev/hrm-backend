...
export class WorkerAcademicDegreeController {
  ...
  @ApiOperation({ summary: 'Create worker academic degree (optional diploma)' })
  async create(
    @Body() dto: CreateWorkerAcademicDegreeDto,
  ...
  @UseInterceptors(FileInterceptor('file'))
  @ApiConsumes('multipart/form-data', 'application/json')
  @ApiOperation({ summary: 'Update worker academic degree' })
  async update(
